package com.sumagoinfotech.digicopy.pagination
...
class MyPaginationAdapter(var pageSize:Int,var currentPage:String,private val listener: OnPageNumberClickListener): RecyclerView.Adapter<MyPaginationAdapter.ViewHolder>() {
