...
class LabourListInReportsAdapter (var list: List<Labour>) : RecyclerView.Adapter<LabourListInReportsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LabourListInReportsAdapter.ViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.item_row_reports_recyclerview,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: LabourListInReportsAdapter.ViewHolder, position: Int) {
