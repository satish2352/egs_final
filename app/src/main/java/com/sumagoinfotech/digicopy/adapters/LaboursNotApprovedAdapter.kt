...
class LaboursNotApprovedAdapter(var labourList: ArrayList<LaboursList>): RecyclerView.Adapter<LaboursNotApprovedAdapter.ViewHolder>() {
    ...
    {
        val view=LayoutInflater.from(parent.context).inflate(R.layout.item_row_labours_not_approved,parent,false)
