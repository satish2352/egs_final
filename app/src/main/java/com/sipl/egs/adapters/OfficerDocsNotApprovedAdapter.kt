...
class OfficerDocsNotApprovedAdapter  (var list:MutableList<DocumentItem>,var onDownloadDocumentClickListener: OnDownloadDocumentClickListener):
    RecyclerView.Adapter<OfficerDocsNotApprovedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: OfficerDocsNotApprovedAdapter.ViewHolder,
        position: Int
    ) {
