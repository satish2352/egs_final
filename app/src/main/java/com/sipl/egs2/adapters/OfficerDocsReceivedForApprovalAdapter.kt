...
import com.sipl.egs2.ui.officer.activities.OfficerDocsEditActivity
import java.text.SimpleDateFormat
import java.util.Date

class OfficerDocsReceivedForApprovalAdapter(var list:MutableList<DocumentItem>,var onDownloadDocumentClickListener: OnDownloadDocumentClickListener):
